...
Retain the existing project LICENSE. Three.js is MIT licensed; its notice is included in `assets/licenses/three.txt`. Fabric uses [Rough Linen by Rico Cilliers and colormass / Poly Haven](https://polyhaven.com/a/rough_linen), released under [CC0](https://polyhaven.com/license). The retained wood albedo was created with imagegen. Social icons come from [Simple Icons](https://simpleicons.org/) under CC0. Monster artwork and marks belong to [Monster Energy](https://www.monsterenergy.com/); Codex character artwork and marks belong to OpenAI. Application icons retain their respective product ownership. Product names identify the owner's equipment; this site is not affiliated with the manufacturers.
